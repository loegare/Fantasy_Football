...
describing that statistical category. The fields are cat, fields, yds,
desc and long.
...
idmap = {
    ...
    10: {
        'cat': 'rushing',
        'fields': ['rushing_att', 'rushing_yds'],
        'desc': 'Rushing yards',
        'long': 'Rushing yards and credit for a rushing attempt.',
    },
    11: {
        'cat': 'rushing',
        'fields': ['rushing_att', 'rushing_tds', 'rushing_yds'],
    ...
    13: {
        'cat': 'rushing',
        'fields': ['rushing_tds', 'rushing_yds'],
    ...
    15: {
        'cat': 'passing',
        'fields': ['passing_att', 'passing_cmp', 'passing_yds'],
        'desc': 'Passing yards',
        'long': 'Passing yards and a pass attempt completed.',
    },
    16: {
        'cat': 'passing',
        'fields': ['passing_att', 'passing_cmp', 'passing_tds', 'passing_yds'],
    ...
    24: {
        'cat': 'receiving',
        'fields': ['receiving_tds', 'receiving_yds'],
    ...
    25: {
        'cat': 'defense',
        'fields': ['defense_int', 'defense_int_yds'],
        'desc': 'Interception yards',
        'long': 'Interception and return yards.',
    },
    26: {
        'cat': 'defense',
        'fields': ['defense_int', 'defense_tds', 'defense_int_tds', 'defense_int_yds'],
    ...
    28: {
        'cat': 'defense',
        'fields': ['defense_tds', 'defense_int_tds', 'defense_int_yds'],
    ...
    29: {
        'cat': 'punting',
        'fields': ['punting_tot', 'punting_yds'],
        'desc': 'Punting yards',
    ...
    32: {
        'cat': 'punting',
        'fields': ['punting_tot', 'punting_touchback', 'punting_yds'],
    ...
    33: {
        'cat': 'puntret',
        'fields': ['puntret_tot', 'puntret_yds'],
        'desc': 'Punt return yards',
        'long': 'Punt return and yards.',
    },
    34: {
        'cat': 'puntret',
        'fields': ['puntret_tot', 'puntret_tds', 'puntret_yds'],
    ...
    36: {
        'cat': 'puntret',
        'fields': ['puntret_tds', 'puntret_yds'],
    ...
    41: {
        'cat': 'kicking',
        'fields': ['kicking_tot', 'kicking_yds'],
        'desc': 'Kickoff yards',
    ...
    44: {
        'cat': 'kicking',
        'fields': ['kicking_tot', 'kicking_touchback', 'kicking_yds'],
        'desc': 'Kickoff with touchback',
        'long': 'Kickoff resulted in a touchback.',
    },
    45: {
        'cat': 'kickret',
        'fields': ['kickret_ret', 'kickret_yds'],
        'desc': 'Kickoff return yards',
        'long': 'Kickoff return and yards.',
    },
    46: {
        'cat': 'kickret',
        'fields': ['kickret_ret', 'kickret_tds', 'kickret_yds'],
    ...
    48: {
        'cat': 'kickret',
        'fields': ['kickret_tds', 'kickret_yds'],
    ...
    55: {
        'cat': 'fumbles',
        'fields': ['fumbles_rec', 'fumbles_rec_yds'],
    ...
    56: {
        'cat': 'fumbles',
        'fields': ['fumbles_rec', 'fumbles_rec_tds', 'fumbles_rec_yds'],
    ...
    58: {
        'cat': 'fumbles',
        'fields': ['fumbles_rec_tds', 'fumbles_rec_yds'],
    ...
    59: {
        'cat': 'defense',
        'fields': ['defense_frec', 'defense_frec_yds'],
    ...
    60: {
        'cat': 'defense',
        'fields': ['defense_frec', 'defense_tds', 'defense_frec_tds', 'defense_frec_yds'],
    ...
    62: {
        'cat': 'defense',
        'fields': ['defense_tds', 'defense_frec_tds', 'defense_frec_yds'],
    ...
    64: {
        'cat': 'defense',
        'fields': ['defense_tds', 'defense_misc_tds', 'defense_misc_yds'],
    ...
    69: {
        'cat': 'kicking',
        'fields': ['kicking_fga', 'kicking_fgmissed', 'kicking_fgmissed_yds'],
        'desc': 'Field goal missed yards',
        'long': 'The length of a missed field goal.',
    },
    70: {
        'cat': 'kicking',
        'fields': ['kicking_fga', 'kicking_fgm', 'kicking_fgm_yds'],
        'desc': 'Field goal yards',
        'long': 'The length of a successful field goal.',
    },
    71: {
        'cat': 'kicking',
        'fields': ['kicking_fga', 'kicking_fgmissed', 'kicking_fgb', 'kicking_fgmissed_yds'],
    ...
    83: {
        'cat': 'defense',
        'fields': ['defense_sk', 'defense_sk_yds'],
    ...
    93: {
        'cat': 'penalty',
        'fields': ['penalty', 'penalty_yds'],
        'desc': 'Penalty',
        'long': '',
    },
    95: {
        'cat': 'team',
        'fields': ['rushing_loss', 'rushing_loss_yds'],
    ...
    402: {
        'cat': 'defense',
        'fields': ['defense_tkl_loss_yds'],
        'desc': 'Tackle for a loss yards',
        'long': '',
    },
    410: {
        'cat': 'kicking',
        'fields': ['kicking_all_yds'],
